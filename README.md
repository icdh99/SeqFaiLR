...
Documentation is available [here](https://delahaye-clara.gitbook.io/seqfailr/). Also in the [wiki](https://github.com/cdelahaye/SeqFaiLR/wiki) (warning, not up to date for the moment, it will be soon) but it has nicer look on the gitbook :)
